...
/**
 * Something that is {@link Invalidable} is one that exhibits observable behaviors that can be
 * rendered invalidated or outdated by calling {@link #invalidate()}.
 *
 * <p>When an object is said to be valid, its private internal state or publicly observable state is
 ...
 * objects that are {@link Invalidable} should provide an explicit method for making oneself valid
 * again, although it is not an enforceable requirement.</p>
 */
