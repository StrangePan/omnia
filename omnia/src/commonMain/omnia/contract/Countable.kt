 ...
 * represented by a non-negative integer anywhere between `0` and [Int.MAX_VALUE].
 *
 *
...
interface Countable {
   ...
   *
   * @return a non-negative integer between `0` and [Int.MAX_VALUE], inclusive.
   */
  val count: Int
   ...
   */
  val isPopulated: Boolean get() = count > 0
}