...
class Quintuplet<T : Any>(first: T, second: T, third: T, fourth: T, fifth: T) :
  Quintuple<T, T, T, T, T>(first, second, third, fourth, fifth), AtMostQuintuplet<T> {
  ...
  override fun concat(item: T): Sextuplet<T> {
    return Tuplet.of(first, second, third, fourth, fifth, item)
  }
