...
open class Septuple<A, B, C, D, E, F, G>(
...
) : AtLeastSeptuple<A, B, C, D, E, F, G>, AtMostSeptuple {

  override val count get() = 7

  override fun equals(other: Any?): Boolean {
    return (other is Septuple<*, *, *, *, *, *, *>
        && first == other.first
        && second == other.second
        && third == other.third
        && fourth == other.fourth
  ...
  override fun <T> append(item: T): Octuple<A, B, C, D, E, F, G, T> {
    return Tuple.of(first, second, third, fourth, fifth, sixth, seventh, item)
  }
