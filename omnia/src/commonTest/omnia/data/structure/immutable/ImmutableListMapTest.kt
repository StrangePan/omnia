  ...
  fun withDuplicates_removesDuplicates() {
    ...
    val underTest =
      ImmutableListMap.builder<Int, String>()
        .addMappingIfAbsent(0, "zero")
        .addMappingIfAbsent(1, "one")
        .addMappingIfAbsent(2, "two")
        .addMappingIfAbsent(3, "three")
        .addMappingIfAbsent(3, "-e")
        .addMappingIfAbsent(0, "15")
        .addMappingIfAbsent(2, "    ")
        .addMappingIfAbsent(1, "-15t2")
        .addMappingIfAbsent(5, "five")
        .addMappingIfAbsent(7, "seven")
        .addMappingIfAbsent(6, "six")
        .addMappingIfAbsent(3, "cbc vbfvx b")
        .addMappingIfAbsent(6, "nm cvcxbnmnb")
        .build()
