...
public interface Septuple<A, B, C, D, E, F, G> extends Tuples.AtLeastSeptuple<A, B, C, D, E, F, G>, Tuples.AtMostSeptuple {
  ...
  @Override
  <H> Octuple<A, B, C, D, E, F, G, H> concat(Monuple<H> other);

  @Override
  <H, I> Nonuple<A, B, C, D, E, F, G, H, I> concat(Couple<H, I> other);

  @Override
  <H, I, J> Decuple<A, B, C, D, E, F, G, H, I, J> concat(Triple<H, I, J> other);
}
