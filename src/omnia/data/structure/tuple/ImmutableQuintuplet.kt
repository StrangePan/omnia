...
internal class ImmutableQuintuplet<T>(first: T, second: T, third: T, fourth: T, fifth: T) : ImmutableQuintuple<T, T, T, T, T>(first, second, third, fourth, fifth), Quintuplet<T> {
