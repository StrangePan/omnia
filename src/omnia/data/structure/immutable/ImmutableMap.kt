...
class ImmutableMap<K, V> : Map<K, V> {
    private val javaMap: kotlin.collections.MutableMap<K, V> = kotlin.collections.HashMap<K, V>()
    fun toBuilder(): Builder<K, V> {
        return buildUpon(this)
    }

    class Builder<K, V> {
        val javaMap: kotlin.collections.MutableMap<K, V> = kotlin.collections.HashMap<K, V>()
    ...
    private constructor()
    private constructor(javaMap: kotlin.collections.MutableMap<K, V>) {
    ...
    override fun entries(): Set<Map.Entry<K, V>> {
        class Entry(private val javaEntry: kotlin.collections.MutableMap.MutableEntry<K, V>)
                : Map.Entry<K, V> {
    ...
    companion object {
        ...
        fun <K, V> of(key: K, value: V): ImmutableMap<K, V> {
            return ImmutableMap<K, V>(Collections.singletonMap(key, value))
        }
