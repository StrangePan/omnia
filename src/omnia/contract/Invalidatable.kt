...
/**
 * Something that is [Invalidatable] is one that exhibits observable behaviors that can be
 ...
 * objects that are [Invalidatable] should provide an explicit method for making oneself valid
